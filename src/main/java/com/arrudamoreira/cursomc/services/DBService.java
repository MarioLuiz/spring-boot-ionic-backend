...
public class DBService {
	...
	public void instanciateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Mario Luiz", "marioluiz.arruda92@gmail.com", "36789878788", TipoCliente.PESSOAFISICA, pe.encode("teste123456"));
		Cliente cli2 = new Cliente(null, "Maria Luiza", "marioluiz.teste@gmail.com", "42853411826", TipoCliente.PESSOAFISICA, pe.encode("teste123456"));
                cli2.addPerfil(Perfil.ADMIN);

		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		cli2.getTelefones().addAll(Arrays.asList("27363324", "93838391"));

		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Capivara", "180", "Sala 800", "Margarida", "38777012", cli2, c5);
